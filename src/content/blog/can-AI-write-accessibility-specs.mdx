...
To appease my conscience, I went with the [GPT-4o-mini model](https://platform.openai.com/docs/models/gpt-4o-mini) - which supposedly means lower electricity consumption and a smaller carbon footprint. At least that's what the guidance says. I mean, why would Sam Altman lie to us?
