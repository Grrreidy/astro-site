...
## Aggregating good practices

When I'm researching the accessibility guidelines for a component, I generally start with WCAG, then pull in various sources from bookmarks.  I got ChatGPT to help me write a prompt, thus demonstrating how the world is just *slowly eating itself*. Here's what we came up with:

☞ [Generate accessibility guidance for a component](https://gerireid.com/componenta11y/)
...
☞ [Generate accessibility docs for a component](https://gerireid.com/a11y-docs/)
