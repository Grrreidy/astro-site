...
Apple is about to drop [Accessibility Nutrition labels](https://developer.apple.com/help/app-store-connect/manage-app-accessibility/overview-of-accessibility-nutrition-labels/) on the App Store, giving users transparency about which accessibility features apps support. I've just completed an audit for one of these labels. Here's what I learned.
...
The labels start as voluntary, but Apple is making them mandatory for new apps and updates eventually. Translation: get ahead of this.

![A screenshot from the Apple App Store showing an Accessibility Nutrition Label](/images/apple-nutrition-label.png)
<span class="figcaption">*How the label appears on the app store, showing which accessibility features the app supports.*</span>
...
Apple's [developer docs](https://developer.apple.com/help/app-store-connect/manage-app-accessibility/overview-of-accessibility-nutrition-labels/) run through a list of accessibility features you need to test your journeys against. Check the evaluation criteria to establish if you pass.
