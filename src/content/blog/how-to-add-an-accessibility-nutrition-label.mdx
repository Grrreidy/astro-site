...
Apple has dropped [Accessibility Nutrition labels](https://developer.apple.com/help/app-store-connect/manage-app-accessibility/overview-of-accessibility-nutrition-labels/) on the App Store, offering users transparency about which accessibility features apps support. I completed an audit for one of these labels. Here's what I learned.
