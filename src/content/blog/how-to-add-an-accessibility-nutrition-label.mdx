...
Apple's [developer docs](https://developer.apple.com/help/app-store-connect/manage-app-accessibility/overview-of-accessibility-nutrition-labels/) outlines a list of accessibility features you need to test your journeys against. Check the evaluation criteria to establish if you pass. The audit needs to be done by someone with experience of accessibilty testing who is familiar with assistive settings and most importantly with user needs. 
