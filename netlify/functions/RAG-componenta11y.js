...
`.trim();
    ...
    const prompt = [
      ...
      "12) <h3>iOS</h3>",
      "   - Notes for iOS with links to the relevant Apple Human Interface Guidelines component page(s). Do not invent links",
      "13) <h3>Android</h3>",
      "   - Notes for Android with links to the relevant Material 3 component page(s). Do not invent links",
      "14) <h3>Design</h3>",
